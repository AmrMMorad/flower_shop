...
describe BundleChooser do
  ...
  context 'returns exactly one solution' do
    let(:bundle1) { Bundle.new(number_of_flowers: 15, price: 15, price_after_offer: 14) }
    let(:bundle2) { Bundle.new(number_of_flowers: 5, price: 5, price_after_offer: 4) }
    let(:bundles) do
      [
        bundle1,
  ...
  context 'returns minimum bundles' do
    let(:bundle1) { Bundle.new(number_of_flowers: 9, price: 9, price_after_offer: 8) }
    let(:bundle2) { Bundle.new(number_of_flowers: 5, price: 5, price_after_offer: 4) }
    let(:bundle3) { Bundle.new(number_of_flowers: 3, price: 3, price_after_offer: 2) }
    let(:bundles) do
      [
        bundle1,
        bundle2,
